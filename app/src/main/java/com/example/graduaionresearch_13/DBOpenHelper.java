...
public class DBOpenHelper extends SQLiteOpenHelper {
    ...
    private void putTestCase(SQLiteDatabase db){
        ...
        bookValues.put(COLUMN_NAME_BOOK_NAME, "難読漢字1");
        bookValues.put(COLUMN_NAME_TIME_LIMIT,  VocabularyBook.DEFAULT_TIME_LIMIT);
        db.insert(TABLE_NAME_BOOKS, null, bookValues);
        ...
        bookValues.put(COLUMN_NAME_TIME_LIMIT,  VocabularyBook.DEFAULT_TIME_LIMIT);
        db.insert(TABLE_NAME_BOOKS, null, bookValues);
        bookValues.put(COLUMN_NAME_BOOK_NAME, "難読漢字2");
        bookValues.put(COLUMN_NAME_TIME_LIMIT,  VocabularyBook.DEFAULT_TIME_LIMIT);
        db.insert(TABLE_NAME_BOOKS, null, bookValues);
        ...
        problemValues.put(COLUMN_NAME_BOOK_ID,1);
        db.insert(TABLE_NAME_PROBLEMS,null,problemValues);
        problemValues.put(COLUMN_NAME_PROBLEM,"(背が)高い");
        problemValues.put(COLUMN_NAME_ANSWER,"tall");
        problemValues.put(COLUMN_NAME_BOOK_ID,1);
        db.insert(TABLE_NAME_PROBLEMS,null,problemValues);
        problemValues.put(COLUMN_NAME_PROBLEM,"若い");
        problemValues.put(COLUMN_NAME_ANSWER,"young");
        problemValues.put(COLUMN_NAME_BOOK_ID,1);
        db.insert(TABLE_NAME_PROBLEMS,null,problemValues);
        problemValues.put(COLUMN_NAME_PROBLEM,"立つ・我慢する");
        problemValues.put(COLUMN_NAME_ANSWER,"stand");
        problemValues.put(COLUMN_NAME_BOOK_ID,1);
        db.insert(TABLE_NAME_PROBLEMS,null,problemValues);
        problemValues.put(COLUMN_NAME_PROBLEM,"偉大な");
        problemValues.put(COLUMN_NAME_ANSWER,"great");
        problemValues.put(COLUMN_NAME_BOOK_ID,1);
        db.insert(TABLE_NAME_PROBLEMS,null,problemValues);
        ...
        problemValues.put(COLUMN_NAME_BOOK_ID,2);
        db.insert(TABLE_NAME_PROBLEMS,null,problemValues);
        problemValues.put(COLUMN_NAME_PROBLEM,"偉丈夫");
        problemValues.put(COLUMN_NAME_ANSWER,"いじょうぶ");
        problemValues.put(COLUMN_NAME_BOOK_ID,2);
        db.insert(TABLE_NAME_PROBLEMS,null,problemValues);
        problemValues.put(COLUMN_NAME_PROBLEM,"好々爺");
        problemValues.put(COLUMN_NAME_ANSWER,"こうこうや");
        problemValues.put(COLUMN_NAME_BOOK_ID,2);
        db.insert(TABLE_NAME_PROBLEMS,null,problemValues);
        problemValues.put(COLUMN_NAME_PROBLEM,"倅");
        problemValues.put(COLUMN_NAME_ANSWER,"せがれ");
        problemValues.put(COLUMN_NAME_BOOK_ID,2);
        db.insert(TABLE_NAME_PROBLEMS,null,problemValues);
        problemValues.put(COLUMN_NAME_PROBLEM,"補填");
        problemValues.put(COLUMN_NAME_ANSWER,"ほてん");
        ...
        problemValues.put(COLUMN_NAME_BOOK_ID,3);
        db.insert(TABLE_NAME_PROBLEMS,null,problemValues);
        problemValues.put(COLUMN_NAME_PROBLEM,"リチウムを燃やした時の色");
        problemValues.put(COLUMN_NAME_ANSWER,"赤");
        problemValues.put(COLUMN_NAME_BOOK_ID,3);
        db.insert(TABLE_NAME_PROBLEMS,null,problemValues);
        problemValues.put(COLUMN_NAME_PROBLEM,"物質がゆっくりと広がっていく現象をなんというか");
        problemValues.put(COLUMN_NAME_ANSWER,"拡散");
        problemValues.put(COLUMN_NAME_BOOK_ID,3);
        db.insert(TABLE_NAME_PROBLEMS,null,problemValues);
        ...
        problemValues.put(COLUMN_NAME_BOOK_ID,4);
        db.insert(TABLE_NAME_PROBLEMS,null,problemValues);
        problemValues.put(COLUMN_NAME_PROBLEM,"1185年に源頼朝が後白河法皇に認めさせた権利のうち、荘園におかれたものは何か");
        problemValues.put(COLUMN_NAME_ANSWER,"地頭");
        problemValues.put(COLUMN_NAME_BOOK_ID,4);
        db.insert(TABLE_NAME_PROBLEMS,null,problemValues);
        problemValues.put(COLUMN_NAME_PROBLEM,"国司に任じられても現地へ行かずに収入だけを得ることをなんというか");
        problemValues.put(COLUMN_NAME_ANSWER,"遙任");
        problemValues.put(COLUMN_NAME_BOOK_ID,4);
        db.insert(TABLE_NAME_PROBLEMS,null,problemValues);
        problemValues.put(COLUMN_NAME_PROBLEM,"地面に堀った穴の上に屋根をかけて作った住居をなんという");
        problemValues.put(COLUMN_NAME_ANSWER,"竪穴住居");
        problemValues.put(COLUMN_NAME_BOOK_ID,4);
        db.insert(TABLE_NAME_PROBLEMS,null,problemValues);

        problemValues.put(COLUMN_NAME_PROBLEM,"砥石");
        problemValues.put(COLUMN_NAME_ANSWER,"といし");
        problemValues.put(COLUMN_NAME_BOOK_ID,5);
        db.insert(TABLE_NAME_PROBLEMS,null,problemValues);
        problemValues.put(COLUMN_NAME_PROBLEM,"抽斗");
        problemValues.put(COLUMN_NAME_ANSWER,"ひきだし");
        problemValues.put(COLUMN_NAME_BOOK_ID,5);
        db.insert(TABLE_NAME_PROBLEMS,null,problemValues);
        problemValues.put(COLUMN_NAME_PROBLEM,"如雨露");
        problemValues.put(COLUMN_NAME_ANSWER,"じょうろ");
        problemValues.put(COLUMN_NAME_BOOK_ID,5);
        db.insert(TABLE_NAME_PROBLEMS,null,problemValues);
        problemValues.put(COLUMN_NAME_PROBLEM,"炬燵");
        problemValues.put(COLUMN_NAME_ANSWER,"こたつ");
        problemValues.put(COLUMN_NAME_BOOK_ID,5);
        db.insert(TABLE_NAME_PROBLEMS,null,problemValues);
        problemValues.put(COLUMN_NAME_PROBLEM,"紫陽花");
        problemValues.put(COLUMN_NAME_ANSWER,"あじさい");
        problemValues.put(COLUMN_NAME_BOOK_ID,5);
        db.insert(TABLE_NAME_PROBLEMS,null,problemValues);
        problemValues.put(COLUMN_NAME_PROBLEM,"鈴蘭");
        problemValues.put(COLUMN_NAME_ANSWER,"すずらん");
        problemValues.put(COLUMN_NAME_BOOK_ID,5);
        db.insert(TABLE_NAME_PROBLEMS,null,problemValues);
